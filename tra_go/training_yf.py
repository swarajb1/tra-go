...
def custom_evaluate_safety_factor_band_2_2(
    ...
    with custom_object_scope(
        {
            "custom_loss_band_2_2": km.custom_loss_band_2_2,
            "metric_rmse": km.metric_rmse,
            "metric_band_error_average_2": km.metric_band_error_average_2,
            "metric_band_hl_correction_2": km.metric_band_hl_correction_2,
            "metric_band_inside_range_2": km.metric_band_inside_range_2,
        }
    ):
    ...
    Y_test_temp[:, :, 0] = Y_test[:, :, 0] - Y_test[:, :, 1]
    Y_test_temp[:, :, 1] = Y_test[:, :, 0] + Y_test[:, :, 1]
    Y_test = Y_test_temp
